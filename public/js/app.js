...
/* harmony import */ var _product_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./product.js */ "./resources/js/product.js");
/* harmony import */ var _product_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_product_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _login_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login.js */ "./resources/js/login.js");
...
function _loadProducts() {
  _loadProducts = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var response, products, tableBody;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 2:
          products = _context.v;
          tableBody = document.getElementById("product-table");
          tableBody.innerHTML = "";
          products.forEach(function (product) {
            var row = "\n            <tr>\n                <td>".concat(product.id, "</td>\n                <td>").concat(product.nama, "</td>\n                <td>Rp ").concat(product.harga, "</td>\n                <td>").concat(product.stok, "</td>\n            </tr>\n        ");
