...
<body>
            ...
            <ul class="space-y-2 font-medium">
                ...
                <script>
                    ...
                    document.addEventListener("DOMContentLoaded", () => {
                        ...
                        // Optional: refresh count setiap 30 detik
                        setInterval(updateNotificationCount, 30000);
                    });
                </script>
                <li>
                    <a href="{{ url('/dashboard/orderadmin') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 18">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Order Detail</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ url('/dashboard/rawmaterial') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 18 20">
                ...
                <li>
                    <a href="{{ url('/dashboard/productrecipe') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="shrink-0 w-5.5 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Product Recipe</span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="h-48 mb-4 bg-gray-50 dark:bg-gray-800 p-6">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            const userType = localStorage.getItem("user_type"); // pastikan sudah disimpan waktu login

            if (userType !== "admin") {
                // kalau bukan admin, balikin ke homepage
